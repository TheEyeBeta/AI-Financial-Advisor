...
| SEV-3 | Degraded with a workaround; single feature or subset of users | market data on snapshot fallback; Redis down (rate limits process-local); academy quiz save flaky |
